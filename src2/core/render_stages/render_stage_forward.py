...
from src2.core.render_stage import RenderStage


class RenderPassForward(RenderStage):
    ...
    def render(self):
        ...
        for render_layer in self.render_layers:
            ...
            # Framebuffer has already been set in render stage"
            ...
            program["projection_matrix"].write(camera.get_projection_matrix().T.tobytes())
