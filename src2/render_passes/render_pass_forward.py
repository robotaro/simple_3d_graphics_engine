...
from src2.render_passes.render_pass import RenderPass


class RenderStageForward(RenderPass):
    ...
    def __init__(self, **kwargs):
        ...
        self.update_window_size(window_size=kwargs["initial_window_size"])
    ...
    def render(self, scene: Scene):
        ...
        for viewport in scene.viewports:
            ...
            for _, entity in scene.entities.items():
