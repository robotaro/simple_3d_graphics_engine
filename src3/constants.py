...
GIZMO_AXIS_X_COLOR_HIGHLIGHT = [1.0, 0.5, 0.5, GIZMO_ALPHA]
GIZMO_AXIS_Y_COLOR_NORMAL = [0.0, 1.0, 0.0, GIZMO_ALPHA]
GIZMO_AXIS_Y_COLOR_HIGHLIGHT = [0.5, 1.0, 0.5, GIZMO_ALPHA]
GIZMO_AXIS_Z_COLOR_NORMAL = [0.0, 0.0, 1.0, GIZMO_ALPHA]
GIZMO_AXIS_Z_COLOR_HIGHLIGHT = [0.5, 5.0, 1.0, GIZMO_ALPHA]

GIZMO_PLANE_XY_COLOR_NORMAL = [0.0, 0.0, 1.0, GIZMO_ALPHA]
GIZMO_PLANE_XY_COLOR_HIGHLIGHT = [0.5, 0.5, 1.0, GIZMO_ALPHA]
GIZMO_PLANE_XZ_COLOR_NORMAL = [0.0, 1.0, 0.0, GIZMO_ALPHA]
GIZMO_PLANE_XZ_COLOR_HIGHLIGHT = [0.5, 1.0, 0.5, GIZMO_ALPHA]
GIZMO_PLANE_YZ_COLOR_NORMAL = [1.0, 0.0, 0.0, GIZMO_ALPHA]
GIZMO_PLANE_YZ_COLOR_HIGHLIGHT = [1.0, 0.5, 0.5, GIZMO_ALPHA]

GIZMO_X_AXIS_VERTICES = [
    [0.0, 0.0, 0.0, GIZMO_AXIS_LINE_WIDTH] + GIZMO_AXIS_X_COLOR_NORMAL,
    [GIZMO_AXIS_LENGTH, 0.0, 0.0, GIZMO_AXIS_LINE_WIDTH] + GIZMO_AXIS_X_COLOR_NORMAL
]

GIZMO_Y_AXIS_VERTICES = [
    [0.0, 0.0, 0.0, GIZMO_AXIS_LINE_WIDTH] + GIZMO_AXIS_Y_COLOR_NORMAL,
    [0.0, GIZMO_AXIS_LENGTH, 0.0, GIZMO_AXIS_LINE_WIDTH] + GIZMO_AXIS_Y_COLOR_NORMAL,
]

GIZMO_Z_AXIS_VERTICES = [
    [0.0, 0.0, 0.0, GIZMO_AXIS_LINE_WIDTH] + GIZMO_AXIS_Z_COLOR_NORMAL,
    [0.0, 0.0, GIZMO_AXIS_LENGTH, GIZMO_AXIS_LINE_WIDTH] + GIZMO_AXIS_Z_COLOR_NORMAL
]
