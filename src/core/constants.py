...
GIZMO_3D_STATE_HOVER_X_AXIS = 1
GIZMO_3D_STATE_HOVER_Y_AXIS = 2
GIZMO_3D_STATE_HOVER_Z_AXIS = 3
GIZMO_3D_STATE_HOVER_XY_PLANE = 4
GIZMO_3D_STATE_HOVER_YZ_PLANE = 5
GIZMO_3D_STATE_HOVER_XZ_PLANE = 6

GIZMO_3D_STATE_TRANSLATE_AXIS = 1
GIZMO_3D_STATE_TRANSLATE_PLANE = 2
GIZMO_3D_STATE_ROTATE_AXIS = 3
...
EVENT_MOUSE_HOVERING_GIZMO_3D = 17
EVENT_MOUSE_NOT_HOVERING_GIZMO_3D = 18
...
SUBSCRIBED_EVENTS_RENDER_SYSTEM = [
    ...
    EVENT_MOUSE_HOVERING_GIZMO_3D,
    EVENT_MOUSE_NOT_HOVERING_GIZMO_3D,
